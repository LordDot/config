...
local old_themes_path = require("gears.filesystem").get_themes_dir()
local dpi = require("beautiful.xresources").apply_dpi

-- {{{ Main
local theme = {}
theme.wallpaper = themes_path .. "Circuit.png"
-- }}}
...
-- {{{ TodoList
theme.todolist_bg = bg_normal
theme.todolist_border = "#505050"
-- }}}
...
theme.menu_submenu_icon      = old_themes_path .. "default/submenu.png"
-- }}}
...
theme.titlebar_minimize_button_normal = old_themes_path .. "default/titlebar/minimize_normal.png"
theme.titlebar_minimize_button_focus  = old_themes_path .. "default/titlebar/minimize_focus.png"
